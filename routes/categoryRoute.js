...
categoryRoute.post('/addCategory', auth.isLogin, upload.single('categoryPhoto'), categoryController.addCategory);
...
categoryRoute.put('/editCategory/:categoryId', auth.isLogin, upload.single('categoryPhoto'), categoryController.editCategory);
